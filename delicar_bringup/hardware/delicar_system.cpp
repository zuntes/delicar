...
#include "delicar_bringup/delicar_system.hpp"
...
{
hardware_interface::CallbackReturn DeliCarSystemHardware::on_init(
  const hardware_interface::HardwareInfo & info)
{
  ...
  logger_ = std::make_shared<rclcpp::Logger>(
    rclcpp::get_logger("controller_manager.resource_manager.hardware_component.system.DeliCar"));
  ...
  if (info_.joints.size() != 2)
  {
    RCLCPP_ERROR(
      get_logger(),
      "DeliCarSystemHardware::on_init() - Failed to initialize, "
...
std::vector<hardware_interface::StateInterface> DeliCarSystemHardware::export_state_interfaces()
{
...
DeliCarSystemHardware::export_command_interfaces()
{
...
hardware_interface::CallbackReturn DeliCarSystemHardware::on_activate(
...
hardware_interface::CallbackReturn DeliCarSystemHardware::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
hardware_interface::return_type DeliCarSystemHardware::read(
...
hardware_interface::return_type delicar_bringup ::DeliCarSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  std::stringstream ss;
  ss << "Writing commands:";
...
PLUGINLIB_EXPORT_CLASS(
  delicar_bringup::DeliCarSystemHardware, hardware_interface::SystemInterface)
